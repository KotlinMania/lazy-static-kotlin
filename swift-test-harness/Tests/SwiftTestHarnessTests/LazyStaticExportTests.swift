...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `LazyStatic.swiftmodule/`
...
//      `import LazyStatic` above would fail at compile time.
//
//   2. The static archive `libLazyStatic.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "LazyStatic" }` and
//      `flattenPackage = "io.github.kotlinmania.lazystatic"` configuration in
...
//      via the `LazyStaticLibrary` product.
//
