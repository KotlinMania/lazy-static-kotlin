...
This file is the quick-reference operating contract for lazy-static-kotlin. The longer
...
lazy-static-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`lazy_static`](https://crates.io/crates/lazy_static). Upstream Rust is the behavioral oracle while the
